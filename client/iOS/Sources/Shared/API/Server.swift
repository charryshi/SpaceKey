...
public extension ServerSettingKey {
    ...
    static var permissionGatewayGrantID: ServerSettingKey<String?> { "permission_gateway_grant_id" }
    static var permissionGatewayURL: ServerSettingKey<String?> { "permission_gateway_url" }
    static var permissionGatewayFrontendURL: ServerSettingKey<String?> { "permission_gateway_frontend_url" }
}
