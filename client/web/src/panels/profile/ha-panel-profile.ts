...
const allProfileSections: PageNavigation[] = [
  {
...
export const profileSections = allProfileSections;

export const getProfileSections = (hass?: HomeAssistant): PageNavigation[] =>
  shouldRestrictPermissionGateway(hass?.permissionSummary, hass?.auth)
    ? allProfileSections.filter((section) => section.path === "/profile/general")
    : allProfileSections;
